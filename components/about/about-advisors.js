  ...
  return (
    <div>
      ...
      <div className="xl:pl-5 2xl:px-44">
        <div className="mx-auto flex flex-row overflow-x-auto pb-7 xl:container 2xl:container 2xl:mx-0 2xl:max-w-xl 2xl:justify-between 3xl:mx-auto 3xl:max-w-screen-2xl 3xl:justify-start">
